# 1 "c:\\users\\administrator\\desktop\\20142983-1\\\\combined_20142983-1.c"
# 1 "globals.h" 1
...
# 917 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lr_save_value (char * param_val,
                                ...
                                char * file_name,
                                long const line_num);
# 924 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
int   lr_set_debug_message (unsigned int msg_class,
                                       unsigned int swtch);
# 946 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 1022 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 1051 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"


# 1063 "C:\\Program Files\\HP\\LoadRunner\\include/lrun.h"
...
# 737 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"


# 750 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"
...
# 788 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"
...
# 856 "C:\\Program Files\\HP\\LoadRunner\\include/as_web.h"
...
# 1 "c:\\users\\administrator\\desktop\\20142983-1\\\\combined_20142983-1.c" 2
...
# 3 "c:\\users\\administrator\\desktop\\20142983-1\\\\combined_20142983-1.c" 2
...
# 4 "c:\\users\\administrator\\desktop\\20142983-1\\\\combined_20142983-1.c" 2
...
Action()
{
	...
	lr_save_string(lr_decrypt("5930db7bee64cc41"), "PasswordParameter");
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=userSession", "Value=121212.982017011zcDtiQcpHzcfDHtAQpDfzfHf", "ENDITEM", 
	...
	web_submit_data("reservations.pl", 
		...
		"Name=departDate", "Value=06/03/2017", "ENDITEM", 
		"Name=arrive", "Value=Seattle", "ENDITEM", 
		"Name=returnDate", "Value=06/04/2017", "ENDITEM", 
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=outboundFlight", "Value=270;565;06/03/2017", "ENDITEM", 
		"Name=numPassengers", "Value=1", "ENDITEM", 
		"Name=advanceDiscount", "Value=0", "ENDITEM", 
		"Name=seatType", "Value=Coach", "ENDITEM", 
		"Name=seatPref", "Value=None", "ENDITEM", 
	...
	web_submit_data("reservations.pl_4", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=Book Another.x", "Value=38", "ENDITEM", 
		"Name=Book Another.y", "Value=10", "ENDITEM", 
		"LAST");

	lr_end_transaction("dingpiao",2);

	lr_think_time(12);

	lr_start_transaction("tuichu");
	...
	lr_end_transaction("tuichu",2);

	return 0;
}
# 5 "c:\\users\\administrator\\desktop\\20142983-1\\\\combined_20142983-1.c" 2
...
# 6 "c:\\users\\administrator\\desktop\\20142983-1\\\\combined_20142983-1.c" 2
